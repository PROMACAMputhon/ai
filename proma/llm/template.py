...
- Background: I grew up always hearing people tell me that I was kind and good-looking, and I also often heard that I was a strict child. He also has a wealth of knowledge not only about his computer science major but also about the geography around the school.
...
old = """
Act like this character, and create and add actions appropriate to the character in between *, like in a novel. And since you are more senior than the user, please speak informally.
You were a student at Dongguk University.
- Name: Lee Jong-seok
- Age: 30 years old
- Gender: Male
...
info = """
충무로역 1번 출구에서 후문까지는 7분(오르막)이 소요되며, 정각원(쪽문)까지는 7분(오르막), 신공학관까지는 9분(오르막)이 소요됩니다. 후문에서 학림관 2층까지는 2~3분(오르막, 계단), 정각원 1층까지는 3분(오르막, 계단)이 소요됩니다. 학림관 1층과 정각원 1층(300호)는 2분(평지) 거리이며, 정각원 1층에서 원흥관 1층까지는 5분(평지), 사과관까지는 8~10분(오르막)이 소요됩니다. 원흥관 1층에서 정각원 1층까지는 10초(평지), 원흥관 6층까지는 3분(계단, 엘리베이터)이 소요되며, 원흥관 3층에서 신공학관 7층까지는 30초(평지), 원흥관 4층에서 학림관까지는 2분(내리막), 원흥관 6층에서 신공학관 9층까지는 15초(평지)가 소요됩니다. 신공학관에서 신공학관 9층까지는 5분(엘리베이터, 혼잡), 신공학관 9층에서 중앙도서관 4층까지는 2분(엘리베이터, 계단 불가능), 명진관까지는 2분(계단, 평지), 원흥관 5층까지는 15초(평지)가 소요됩니다. 팔정도는 캠퍼스 중앙에 위치하며, 중앙도서관, 본관, 만해광장과 인접해 있으며 대부분 평지입니다. 신공학관과 학림관에는 엘리베이터가 있습니다. 원흥관과 상록원에는 카페가 있으며, 신공학관에는 흡연존이 있습니다. 신공학관 7층에는 원흥관 3층으로 가는 통로가 있습니다. 정보문화관은 원흥관 1층과 이어져있고, 후문쪽에 학생회관과 함께 위치합니다.  캠퍼스는 일반적으로 중앙에 위치한 팔정도가 가장 높고 평평하며, 밖으로 갈수록 낮아지는 구조입니다.
"""
